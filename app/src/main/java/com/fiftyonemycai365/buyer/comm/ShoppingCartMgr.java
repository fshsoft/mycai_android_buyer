package com.fiftyonemycai365.buyer.comm;
...
public class ShoppingCartMgr {
    ...
    public boolean saveShopping(final FragmentActivity context, final int goodsId, final int normsId, String serviceTime, final int num, final String tag) {
                ...
                CartSellerListResult.class, new Response.Listener<CartSellerListResult>() {
                    ...
                    public void onResponse(final CartSellerListResult response) {
                        ...
                        if (O2OUtils.checkResponse(context, response)) {
                            ...
                            EventBus.getDefault().post(new ShoppingCartEvent(goodsId, normsId, true, tag, num));
                        } else {
                            EventBus.getDefault().post(new ShoppingCartEvent(goodsId, normsId, false, tag, num));
                        }
        ...
        ApiUtils.post(context, URLConstants.SHOPPING_DELETE,
                ...
                CartSellerListResult.class, new Response.Listener<CartSellerListResult>() {
                    ...
                    public void onResponse(final CartSellerListResult response) {
                        ...
                        if (O2OUtils.checkResponse(context, response)) {
                            setCart(response.data);
                            EventBus.getDefault().post(new ShoppingCartEvent(0, 0, true, tag, 0));
                        } else {
                            EventBus.getDefault().post(new ShoppingCartEvent(0, 0, false, tag, 0));
                        }
