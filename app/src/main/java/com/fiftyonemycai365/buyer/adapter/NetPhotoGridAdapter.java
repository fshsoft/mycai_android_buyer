...
public class NetPhotoGridAdapter extends CommonAdapter<String> {
    private final String TAG = "PhotoGridAdapter";
    private int MAX_COUNT = 4;
    private IPhotoFunc mPhotoFunc;

    public NetPhotoGridAdapter(Context context, List<String> datas) {
        super(context, datas, R.layout.item_net_square_photo);
