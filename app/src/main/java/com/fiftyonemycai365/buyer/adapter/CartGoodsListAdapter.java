...
public class CartGoodsListAdapter extends CommonAdapter<CartGoodsInfo> {
    ...
    public void convert(final ViewHolder helper, final CartGoodsInfo item, int position) {
        ...
        helper.getView(R.id.tv_price).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startTurnGoodsDetail(item.goodsId);
            }
        });
    ...
    private void startTurnGoodsDetail(int goodsId){
        Intent intent = new Intent(mContext, GoodDetailActivity.class);
        intent.putExtra(Constants.EXTRA_DATA,goodsId);
