...
import com.fiftyonemycai365.buyer.activity.AddCommentActivity;
import com.fiftyonemycai365.buyer.activity.MainActivity;
import com.fiftyonemycai365.buyer.activity.PayWayActivity;
...
public class OrderListAdapter extends CommonAdapter<OrderInfo> {
    ...
    public void convert(ViewHolder helper, final OrderInfo item, final int position) {
        ...
        helper.setText(R.id.tv_pay_need, formatPriceText(mContext.getResources().getString(R.string.price_yuan, item.payFee)));
...
//                    EventBus.getDefault().post(new GotoHomeEvent(0));
        ...
        helper.getView(R.id.btn_right).setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                Log.e("TOUCH", "event: " + event.getAction());
                return false;
            }
        });
    }
