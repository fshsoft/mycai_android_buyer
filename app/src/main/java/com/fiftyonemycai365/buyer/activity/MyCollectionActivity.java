...
import com.fiftyonemycai365.buyer.fragment.MerchandiseFragment;
import com.fiftyonemycai365.buyer.fragment.ShopFragment;
...
public class MyCollectionActivity extends BaseActivity implements BaseActivity.TitleListener ,View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setPageTag(TagManager.MY_COLLECTION_ACTIVITY);
        initViews();
