...
import com.fiftyonemycai365.buyer.utils.FileCache;
...
public class JoinBusinessActivity extends BaseActivity implements BaseActivity.TitleListener, OnClickListener, CropHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setPageTag(TagManager.JOIN_BUSINESS_ACTIVITY);
        initView();
        OSSUtils.init(this);
        FileCache.init(this);
        initSeller();
        ...
        switch (v.getId()) {
            ...
            case R.id.join_range_tv:
                if (mSelPointInfo == null){
                    ToastUtils.show(JoinBusinessActivity.this,"请先选择店铺地址");
                }else{
                    Intent intent1 = new Intent(this, ShopRangeActivity.class);
                    intent1.putExtra("mapPoint",String.valueOf(mSelPointInfo.x+","+mSelPointInfo.y));
