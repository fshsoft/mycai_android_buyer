...
import com.fiftyonemycai365.buyer.adapter.GoodNormsAdapter;
...
import com.fiftyonemycai365.buyer.widget.flow.FlowLayout;
...
public class GoodNormsActivity extends FragmentActivity implements OnClickListener {
    ...
    protected void onResume() {
        super.onResume();
        ZYStatConfig.onPageResume(this, "A商品规格");
    }

    @Override
    protected void onPause() {
        super.onPause();
        ZYStatConfig.onPagePause(this, "A商品规格");
    }
                ...
                CartSellerListResult.class, new Response.Listener<CartSellerListResult>() {
                    ...
                    public void onResponse(final CartSellerListResult response) {
                        ...
                        if (O2OUtils.checkResponse(GoodNormsActivity.this, response)) {
                            ...
                            EventBus.getDefault().post(new ShoppingCartEvent(mGoodInfo.id, finalNormsId, true, getResources().getString(R.string.shopping_cat_event), num));
