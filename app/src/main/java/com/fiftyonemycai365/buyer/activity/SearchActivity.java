...
import com.fiftyonemycai365.buyer.adapter.SearchHotListAdapter;
import com.fiftyonemycai365.buyer.adapter.SearchHistoryAdapter;
...
import com.fiftyonemycai365.buyer.widget.MyListView;
...
public class SearchActivity extends BaseActivity implements BaseActivity.TitleListener,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
        setPageTag(TagManager.SEARCH_ACTIVITY);
        getSearch();
    }
