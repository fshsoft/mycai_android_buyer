...
import com.fiftyonemycai365.buyer.utils.CacheUtils;
...
public class AddCommentActivity extends BaseActivity implements BaseActivity.TitleListener, OnClickListener {
    ...
    private void initView() {
        ...
        mPhotoGridAdapter = new PhotoGridAdapter(this, new ArrayList<String>(), 4, true);
    ...
    private void uploadPics() {
        ...
        Log.e("size", mPhotoUris.size() + "" + new Gson().toJson(mPhotoUris));
            ...
            for (int i = 0; i < size; i++) {
                ...
                OSSUtils.save(path, new SaveCallback() {
                    ...
                    public void onSuccess(String arg0) {
                        mPhotoKeys.add(arg0);
                        Log.e("返回路径", index + "" + arg0);
                        Log.e("mPhotoKeys", new Gson().toJson(mPhotoKeys));
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                if (mPhotoKeys.size() == mPhotoUris.size()) {
                    uploadData();
                }
        ...
        switch (requestCode) {
            ...
            case REQUEST_ALBUM:
                ...
                if (Build.VERSION.SDK_INT >= 19) {
                    photoUri = CropHelper.uriFormat(this, photoUri);
                }
